...
import { MusicTracksEditor } from "@/features/config/components/admin/music-editor";
import { QuotesEditor } from "@/features/config/components/admin/quotes-editor";
  ...
  return (
    <div className="site-studio">
      ...
      <SettingsDisclosure
        title={
          <span className="site-section-copy">
            <strong>{m.settings_site_section_music_title()}</strong>
            <span className="site-section-hint">
              {m.settings_site_section_music_desc()}
            </span>
          </span>
        }
      >
      ...
      <SettingsDisclosure
        title={
          <span className="site-section-copy">
            <strong>{m.settings_site_section_quotes_title()}</strong>
            <span className="site-section-hint">
              {m.settings_site_section_quotes_desc()}
            </span>
          </span>
        }
      >
